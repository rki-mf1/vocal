...
def main(args):
    ...
    vocal_version = args.vocal_version
    vocal_DB_version =args.db_version
    ecdc = args.ecdc
    email = args.email
    email_sum = args.email_sum
...
if __name__ == '__main__':
    ...
    parser.add_argument('-v', '--vocal_version', 
                        help='.version file',
                        required=True)
    parser.add_argument('-d', '--db_version', 
                        help='data/.db_version file',
                        required=True)
    parser.add_argument('-e', '--ecdc', 
                        help='ECDC_assigned_variants.csv file',
                        required=True)
    parser.add_argument('-m', '--email', 
                        help='email.html file',
                        required=True)
    parser.add_argument('-n', '--email_sum', 
                        help='email.sum.html file',
                        required=True)
