...
def main():
    ...
    parser.add_argument("--msg-file", help="Text file with contents of message", default="-")
    parser.add_argument("--to", help="Email addresses to send message to (comma delimited)")
    parser.add_argument("--frm", help="Email addresses to send message from (one address)")
    ...
    rkimail(msg, args.subject, args.to, args.frm, args.cc, args.bcc, args.attachments,_html)


# send internal rki mails
def rkimail(message, subject, to, frm = "kongkitimanonk@rki.de", cc = None, bcc = None, files = None, html=False):
